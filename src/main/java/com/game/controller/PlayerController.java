...
public class PlayerController {
    ...
    public Integer getPlayersCount(
        ...
        return playerService.getPlayers(name, title, race, profession, after, before, banned
                , minExperience, maxExperience, minLevel, maxLevel,null,null,null).size();
    }
    ...
    public ResponseEntity<Player> updatePlayer(@PathVariable(value = "id") String pathId
        ...
        if (savedPlayer == null) return entity;

        final Player result;
        try { result = playerService.updatePlayer(savedPlayer,player);}
